...
Lo primero que hay que considerar es la conexión con la base de datos que necesitamos para nuestro modelo. Es necesario ya contar con al menos una relación en nuestro esquema de base de datos. \textit{Beego} provee una tres ``drivers'' para 
